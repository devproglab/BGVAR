...
compute_irf <- function(A_draw, S_draw, Ginv_draw, type, nhor, draw_idx, shocklist_in, save_rot, seed = -1L) {
    .Call(`_BGVAR_compute_irf`, A_draw, S_draw, Ginv_draw, type, nhor, draw_idx, shocklist_in, save_rot, seed)
}
